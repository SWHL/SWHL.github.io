...
为了实现自动化版本号功能，我写了一个库：[GetPyPiLatestVersion](https://github.com/SWHL/GetPyPiLatestVersion)。这个库可以获得指定库的最新版本。
...
我按照上面的逻辑用了很久，也逐渐习惯了这种模式。直到前几天 [@vshawrh](https://github.com/vshawrh) 提的两个问题：[#667](https://github.com/RapidAI/RapidOCR/discussions/667) [#685](https://github.com/RapidAI/RapidOCR/issues/685)，暴漏了当前模式的缺陷。
...
这一块，我写了相关文档：[如何自行构建指定版本的 rapidocr whl 包](https://rapidai.github.io/RapidOCRDocs/latest/install_usage/rapidocr/package/build-custom-version-rapidocr-whl/#6-wheel)
