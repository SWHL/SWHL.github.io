...
canonical_url: "https://swhl.github.io/main/blog/accelerate-onnx-models-with-coreml-on-macos/"
markdown_url: "https://swhl.github.io/main/blog/accelerate-onnx-models-with-coreml-on-macos.md"
description: "作为深度学习工程师，我们经常面临一个问题：如何在 Apple 设备上高效地部署已有的 ONNX 模型？本文将深入探讨两种主要方案，并通过实际测试给出详细的性能和精度对比。"
---

# 在 macOS 上使用 CoreML 加速 ONNX 模型推理：完全指南

> Canonical URL: https://swhl.github.io/main/blog/accelerate-onnx-models-with-coreml-on-macos/
> Markdown URL: https://swhl.github.io/main/blog/accelerate-onnx-models-with-coreml-on-macos.md
