...
2. 读取标签：打开 NFC Tools 客户端，点击“读取”标签，将空白或已有 NFC 标签靠近手机背面（通常在摄像头附近），即可查看标签容量和内部数据。
3. 写入数据：选择“写入”功能，点击“添加记录”，输入文字、网址、联系方式或电话号码等，再点击写入并将标签贴近手机即可完成。

## 有趣用法

### 碰一下链接无线 (仅限安卓手机碰)

> 以下来自：https://www.ifanr.com/app/1487859
...
目前仅能开着 NFC 功能的安卓手机碰一下，可以链接，苹果手机可以制作，但是不能通过碰一下，链接 wifi。

### 碰一下打开网易云音乐每日推荐（仅限苹果手机）
